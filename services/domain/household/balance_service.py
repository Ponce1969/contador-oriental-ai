...
class HouseholdBalanceService:
    ...
    def compute_balance(
        ...
        for member in members:
            ...
            settlement_data = settlements.get(
                fid, {"paid": Decimal("0"), "received": Decimal("0")}
            )

            # Net balance = (Equal Share) - (Contributed) - (Settlements Paid) +
            ...
            net = (
                equal_share
                - contributed
                - settlement_data["paid"]
                + settlement_data["received"]
            )
