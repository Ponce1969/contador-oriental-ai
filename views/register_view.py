...
class RegisterView:
    ...
    def __init__(self, page: ft.Page, router=None):
        ...
        self.error_text = ft.Text(
            value="", color=ft.Colors.RED_400, size=14, text_align=ft.TextAlign.CENTER
        )
        ...
        return ft.Container(
            content=ft.Column(
                controls=[
                    ...
                    ft.Icon(ft.Icons.PEOPLE, size=80, color=ft.Colors.BLUE_700),
                    ft.Text(
                        "Registro de Familia",
                        size=32,
                    ...
                    ft.Text("Datos de la Familia", size=18, weight=ft.FontWeight.BOLD),
                    self.familia_nombre_field,
                    self.familia_email_field,
                    ft.Container(height=10),
                    ft.Text(
                        "Usuario Administrador", size=18, weight=ft.FontWeight.BOLD
                    ),
