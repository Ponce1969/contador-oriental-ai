...
class InviteView:
    ...
    def render(self) -> ft.Control:
            ...
            return MainLayout(
                ...
                content=ft.Container(
                    content=ft.Column(
                        [
                            ft.Icon(
                                ft.Icons.ERROR_OUTLINE, size=64, color=ft.Colors.RED_400
                            ),
                            ft.Text(
            ...
            return MainLayout(
                ...
                content=ft.Container(
                    content=ft.Column(
                        [
                            ft.Icon(
                                ft.Icons.TIMER_OFF, size=64, color=ft.Colors.ORANGE_400
                            ),
                            ft.Text(
                            ...
                            ft.Text(
                                "Pedile un nuevo enlace a tu amigo "
                ...
                content=ft.Container(
                    content=ft.Column(
                        [
                            ...
                            ft.Text(
                                "¡Te han invitado a compartir gastos!",
                                size=24,
                                weight=ft.FontWeight.BOLD,
                                text_align=ft.TextAlign.CENTER,
                            ),
                            ft.Text(
                                "Para aceptar la invitación, necesitás "
                                "tener una cuenta en Contador Oriental.",
                                text_align=ft.TextAlign.CENTER,
                            ),
                            ft.Container(height=20),
                            ft.Row(
        ...
        def on_accept(e):
            ...
            if not familia_id or not self.token:
                return
            ...
            if res.is_ok():
                ...
                self.page.overlay.append(
                    ft.SnackBar(
                        ft.Text("¡Invitación aceptada exitosamente!"),
            ...
            content=ft.Container(
                content=ft.Column(
                    [
                        ...
                        ft.Text(
                            "Invitación a Hogar", size=24, weight=ft.FontWeight.BOLD
                        ),
                        ft.Text(
                            "¿Querés aceptar la invitación y unirte al grupo "
