        ...
        def on_create(e):
            ...
            if res.is_ok():
                self.page.snack_bar = ft.SnackBar(
                    ft.Text("Hogar creado con éxito", color=ft.Colors.WHITE),
                ...
                self.page.snack_bar = ft.SnackBar(
                    ft.Text(f"Error: {res.unwrap_err()}", color=ft.Colors.WHITE),
        ...
        def on_join(e):
            ...
            if res.is_ok():
                self.page.overlay.append(
                    ft.SnackBar(
                        ft.Text("Te uniste al Hogar con éxito", color=ft.Colors.WHITE),
                        bgcolor=ft.Colors.GREEN_600,
                        open=True,
                    )
                )
        ...
        return ft.Container(
            content=ft.Column(
                [
                    ...
                    ft.Text(
                        "Compartí gastos con otras personas",
                        size=28,
                        weight=ft.FontWeight.BOLD,
                        color=ft.Colors.BLUE_GREY_900,
                    ),
                    ft.Text(
                        "¿Te mudaste con un compañero? ¿Te vas de viaje con amigos? "
                        "¿Querés dividir las cuentas con tu pareja?\n\n"
                        "Un 'Hogar Compartido' te permite vincular tu cuenta "
                        "con la cuenta de otros usuarios de Contador Oriental "
                        "para que todos puedan sumar gastos al pozo común y ver "
                    ...
                    ft.Card(
                        ...
                        content=ft.Container(
                            ...
                            content=ft.Column(
                                [
                                    ft.Text(
                                        "Crear un nuevo Hogar Compartido",
                                        size=18,
                                        weight=ft.FontWeight.BOLD,
                                        color=ft.Colors.BLUE_GREY_800,
                                    ),
                                    ft.Text(
                                        "Elegí un nombre para el grupo:",
                        ...
                        content=ft.Container(
                            ...
                            content=ft.Column(
                                [
                                    ...
                                    ft.Text(
                                        "Pegá el token de invitación acá:",
                                        color=ft.Colors.BLUE_GREY_600,
                                        size=14,
                                    ),
                                    ft.Container(height=10),
        ...
        if not self.household:
            ...
            destinatario_dropdown = ft.Dropdown(
                ...
                options=[
                    ...
                    if b.familia_id != current_familia_id
                ],
            )
            monto_field = ft.TextField(
                label="Monto ($)", keyboard_type=ft.KeyboardType.NUMBER
            )
            ...
            def on_settle(e):
                ...
                try:
                    ...
                    if res.is_ok():
                        self.page.overlay.append(
                            ft.SnackBar(
                                ft.Text("Pago registrado con éxito"),
                                bgcolor=ft.Colors.GREEN_600,
                                open=True,
                            )
                        )
                        ...
                        self.page.overlay.append(
                            ft.SnackBar(
                                ft.Text(f"Error: {res.unwrap_err()}"),
                                bgcolor=ft.Colors.RED_600,
                                open=True,
                            )
                        )
            ...
            settlement_dialog = ft.AlertDialog(
                ...
                content=ft.Container(
                    ...
                    content=ft.Column(
                        [
                            ft.Text(
                                "Registrá un pago que le hiciste a otro miembro "
                                "por fuera de la app."
                            ),
                            ft.Container(height=10),
                    ...
                    ft.Card(
                        content=ft.Container(
                            ...
                            content=ft.Column(
                                [
                                    ft.Text(
                                        b.familia_nombre, weight=ft.FontWeight.BOLD
                                    ),
                                    ft.Text(f"Aportó: $ {b.total_contributed:.2f}"),
                                    ft.Text(
                                        f"Balance: $ {b.net_balance:.2f}",
                                        color=ft.Colors.RED
                                        if b.net_balance > 0
            ...
            def on_leave(e):
                ...
                if res.is_ok():
                    self.page.overlay.append(
                        ft.SnackBar(
                            ft.Text("Abandonaste el hogar exitosamente."),
                            bgcolor=ft.Colors.GREEN_600,
                            open=True,
                        )
                    )
                    ...
                    self.page.overlay.append(
                        ft.SnackBar(
                            ft.Text(f"No podés salir: {res.unwrap_err()}"),
                            bgcolor=ft.Colors.RED_600,
                            open=True,
                        )
                    )
            ...
            content = ft.Column(
                [
                    # ── Cabecera: crema cálido, ancho 100% ──────────────────
                    ft.Container(
                        content=ft.Row(
                            [
                                ft.Text(
                                    f"Hogar: {self.household.nombre}",
                                    size=24,
                                    weight=ft.FontWeight.BOLD,
                                    color=ft.Colors.BLUE_GREY_800,
                                ),
                    ...
                    # ── Acciones: sin contenedor, sobre el fondo base ───────
                    ft.Row(
                        [
                            ft.ElevatedButton(
                                "Saldar Deuda (Registrar Pago)",
                    ...
                    # ── Footer: lila suave, ancho 100%, al fondo ────────────
                    ft.Container(
                        content=ft.Text(
                            "Contador Oriental · Hogares Compartidos",
                            size=11,
                            color=ft.Colors.BLUE_GREY_400,
                            italic=True,
                        ),
