...
class FamilyMember(BaseModel):
    ...
    nombre: str = Field(
        min_length=1,
        max_length=100,
        description="Nombre completo del miembro o mascota",
    )

    # Tipo de miembro
    tipo_miembro: str = Field(
        default="persona", max_length=20, description="Tipo: persona o mascota"
    )
    ...
    # Edad
    edad: int | None = Field(
        default=None, ge=0, le=150, description="Edad del miembro o mascota"
    )
    ...
    notas: str | None = Field(
        default=None, max_length=500, description="Notas adicionales sobre el miembro"
    )
